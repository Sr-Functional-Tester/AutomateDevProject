Using this Test Project, you can automate generating your spring boot dev project using simple yaml file. This is test project automation which can generate you all models, controllers, 
